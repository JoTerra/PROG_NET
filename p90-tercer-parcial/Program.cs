...
void Inicializar() {
    ...
    if(red is null) {
        ...
        red.AgregarNodo(new Nodo(ip:"192.168.0.10", tipo:"servidor", puertos:5, saltos:10, so:"Ubuntu"));
        ...
        red.AgregarNodo(new Nodo(ip:"192.168.0.15", tipo:"servidor", puertos:10, saltos:22, so:"Linux Mint"));
